...
**Date:** 2026-04-08
**Scope:** Unit tests (97) + Cypress E2E tests (~90) for `webapps/provider-calendar`
...
|--------|-----------|-----------|
| Total tests analyzed | 97 | ~90 |
| Relevant | **97 (100%)** | **~86 (96%)** |
| Irrelevant / Stale | 0 | 2 skipped (SQUAWK tickets), 1 behind off-by-default flag |
| High-priority missing gaps | 6 | 4 |
...
| # | Suggested Test | What It Would Test | Priority |
|---|----------------|-------------------|----------|
| 1 | Mobile appointment card interaction | Mobile renders appointment blocks but no tap test exists. | **High** |
| 2 | Mobile busy block interaction | No mobile test for clicking/creating a busy block. | Medium |
| 3 | Mobile availability block interaction | No mobile test for clicking an availability block. | Medium |
...
| 2 | mobile-calendar-page-tests | Mobile appointment card interaction (tap to open) |
...
| Tests | Flag | Default |
|-------|------|---------|
| #5, #7 | `ProviderInterface_ShouldUseNewModifyAppointmentModal` | OFF |
| #69-73 | `ProviderCalendar_MultiDayBlocks` | OFF |
| #78-79 | `ProviderCalendar_MobileView` | OFF |
